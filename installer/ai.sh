...
# global variables
VERSION="2.4"
DOWNLOAD_URL="http://max-evans.ru/ovz-web-panel-$VERSION.tgz"
...
FORCE=0 # force installation to the same directory1
PRESERVE_ARCHIVE=0
AUTOSOLVER=1 # automatic solving of dependencies1
DISTRIB_ID=""
DEBUG=0
UPGRADE=0
UNINSTALL=0
